...
class HomeController extends Controller
{
    public function index()
    {
        $projectsData = [
            ...
            ['id' => 3, 'title' => 'GitPR CLI', 'description' => 'Automação de fluxo Git com IA — Code Reviews, descrições de PR, commits semânticos e muito mais, direto do seu terminal.', 'image' => '/assets/img/projects/logo_gitpr.png', 'tags' => ['Python'],"url" => 'https://gitpr.natanfiuza.dev.br'],
        ...
        $contactInfoData = [
            ...
            'social' => [
                ...
                [ 'name' => 'X (Twitter)', 'url' => 'https://x.com/natanfiuza', 'iconClass' => 'fab fa-twitter' ], // ou fa-x-twitter
            ]
        ];
